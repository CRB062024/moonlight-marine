    ...
    <main className="mock-home">
      ...
      <section className="design-hero">
        ...
        <div className="sailboat-frame">
          <img src="https://raw.githubusercontent.com/CRB062024/moonlight-marine/main/public/moonlight-new-hero.jpg?v=photos-restore-final" alt="Sailboat at sunset on open water" className="approved-hero-image" width="1200" height="1200" loading="eager" fetchPriority="high" />
        </div>
      </section>
