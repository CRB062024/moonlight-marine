    ...
    <main className="mock-home">
      ...
      <section className="design-hero">
        ...
        <div className="sailboat-frame">
          <img src="/moonlight-new-hero.jpg?v=restore-20260921" alt="Sailboat at sunset on open water" className="approved-hero-image" width="1200" height="1200" loading="eager" fetchPriority="high" />
        </div>
      </section>
