    ...
    <main className="site-page shared-page">
      ...
      <section className="detail service-detail">
        <div className="detail-photo">
          <img src="/moonlight-approved-hero-square.jpg?v=sitewide-20260924" alt="Close-up of sailboat on the water" width="1200" height="1200" loading="eager" fetchPriority="high" />
        </div>
