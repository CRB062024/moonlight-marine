    ...
    <main className="site-page">
      ...
      <section className="detail contact-detail">
        ...
        <div className="detail-copy contact-list">
          <p style={{ marginBottom: "30px" }}><small>Phone</small><a href="tel:+15046069029">(504) 606-9029</a></p>
          <p style={{ marginBottom: "30px" }}><small>Fax</small><span>(985) 845-7468</span></p>
          <p style={{ marginBottom: "30px" }}><small>Email</small><a href="mailto:info@moonlightmarine.com">info@moonlightmarine.com</a></p>
